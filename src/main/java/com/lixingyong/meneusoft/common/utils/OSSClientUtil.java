...
public class OSSClientUtil {
    ...
    public static String uploadObject2OSS(OSSClient ossClient, File file, String bucketName, String folder) {
        ...
        return uploadObject2OSS(ossClient,is,fileName,bucketName,folder);
    }
     ...
     * @return String 返回的唯一MD5数字签名
     */
    public static String uploadObject2OSS(OSSClient ossClient,InputStream inputStream,String fileName,String bucketName, String folder) {
