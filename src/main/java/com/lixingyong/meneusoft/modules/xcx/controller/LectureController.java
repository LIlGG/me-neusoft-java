...
public class LectureController {
    ...
    public R searchLecture(@RequestParam("title") String title, @RequestParam("page") int page, @RequestParam("page_size") int pageSize, @RequestParam("start_time") String startTime){
